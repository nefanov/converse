...
# бесконтекстные проверки осуществляются иерархично, от более строгого условия системного вызова к менее, при соответствии - остановка.
# контекстные проверки осуществляются иерархично, но, в отличие от бесконтекстных, при соответствии требуется продолжать проверку.
